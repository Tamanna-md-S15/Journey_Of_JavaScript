...
form.addEventListener('submit',(e)=>{
    ...
    const year = parseInt(document.getElementById('year').value);
        ...
        const text =`Hi ${name} ${lastName}, Your ZODIAC sign is ${zodiacSigns[month-1]}
        . ${compliments[(day-1)%compliments.length]}. ${victimCardCompliments[year%victimCardCompliments.length]}. ${recommendations[month-1]}. 
        ${predictions[(name.length*lastName.length)%predictions.length]}`;
